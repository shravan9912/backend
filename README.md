...
backend is a multipath implementation of the [quic-go](https://github.com/lucas-clemente/quic-go) protocol
...
This version of backend is not dependent on quic-go, and can be installed as a standalone package
...
An application that does File Transfer using backend has been shown at [MPQUIC-FTP](https://github.com/shravan9912/mpquic_ftp)

In case of any issue accessing it, please reach out to repository owner

## Contributing

We are always happy to welcome new contributors! We have a number of self-contained issues that are suitable for first-time contributors, they are tagged with [want-help](https://github.com/shravan9912/backend/issues?q=is%3Aopen+is%3Aissue+label%3Awant-help). If you have any questions, please feel free to reach out by opening an issue or leaving a comment.

## Acknowledgment
- Thanks to [Qdeconinck](https://github.com/qdeconinck/backend) for starting this amazing work
