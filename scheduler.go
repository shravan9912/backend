...
import (
	...
	"github.com/shravan9912/backend/ackhandler"
	"github.com/shravan9912/backend/constants"
	"github.com/shravan9912/backend/internal/protocol"
	"github.com/shravan9912/backend/internal/utils"
	"github.com/shravan9912/backend/internal/wire"
	"github.com/shravan9912/backend/util"
)
...
func (sch *scheduler) setup() {
	...
	sch.DumpPath = "/tmp/"
	sch.dumpAgent.Setup()\
	if sch.SchedulerName == "actor_critic" {
		// change values
...
// actor_critic scheduler
func (sch *scheduler) selectPathActorCritic(s *session, hasRetransmission bool, hasStreamRetransmission bool, fromPth *path) *path {
